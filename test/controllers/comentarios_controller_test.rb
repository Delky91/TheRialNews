...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { content: @comentario.content, publicacion_id: @comentario.publicacion_id, user_id: @comentario.user_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { content: @comentario.content, publicacion_id: @comentario.publicacion_id, user_id: @comentario.user_id } }
